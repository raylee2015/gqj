...
@Controller
@RequestMapping("/bpbj/manufacturer")
public class BPBJManufacturerController extends BaseController {
	public static final Logger LOGGER = Logger
			.getLogger(BPBJManufacturerController.class);
	...
	public ModelAndView toIndex() {
		return new ModelAndView("/bpbj/manufacturer/index");
	}
	...
	public ModelAndView openEditUI(
		...
		return new ModelAndView("/bpbj/manufacturer/editUI");
	}
