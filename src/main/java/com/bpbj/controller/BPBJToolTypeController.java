...
@Controller
@RequestMapping("/bpbj/tool_type")
public class BPBJToolTypeController extends BaseController {
	public static final Logger LOGGER = Logger
			.getLogger(BPBJToolTypeController.class);
	...
	public ModelAndView openEditUI(
		...
		return new ModelAndView("/bpbj/tool_type/editUI");
	}
	...
	public ModelAndView toIndex() {
		return new ModelAndView("/bpbj/tool_type/index");
	}
