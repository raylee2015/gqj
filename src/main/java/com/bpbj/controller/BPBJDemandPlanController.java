...
import com.bpbj.service.IBPBJDemandPlanDetailService;
...
import com.bpbj.util.PlanStatus;

@Controller
@RequestMapping("/bpbj/demand_plan")
public class BPBJDemandPlanController extends BaseController {
	public static final Logger LOGGER = Logger
			.getLogger(BPBJDemandPlanController.class);

	@Autowired
	private IBPBJDemandPlanDetailService demandPlanDetailService;
	...
	public Map<String, Object> exportDemandPlans(
		...
		DemandPlan demandPlan = new DemandPlan();
		demandPlan.setIds(demandPlanIds);
		Map<String, Object> result = demandPlanService
	...
	public Map<String, Object> exportParentDemandPlans(
		...
		demandPlan.setIds(demandPlanIds);
		Map<String, Object> result = demandPlanService
				.exportParentDemandPlans(demandPlan);
		ArrayList<String> exportFileList = (ArrayList<String>) result
				.get("exportFileList");
		downLoadFile(request, response, exportFileList);
		return null;
	...
	public ModelAndView openChooseToolDemandUI(
			HttpServletRequest request, HttpServletResponse response) {
		return new ModelAndView("/bpbj/demand_plan/chooseToolDemandUI");
	}
	...
	public ModelAndView openChooseUserForAnnualPlanUI(
			HttpServletRequest request, HttpServletResponse response) {
		return new ModelAndView("/bpbj/demand_plan/chooseUserUI");
	}
	...
	public ModelAndView openChooseDeptForAnnualPlanUI(
		...
		return new ModelAndView(
				"/bpbj/demand_plan/chooseDeptForAnnualPlanUI");
	}
	...
	public ModelAndView toIndex(HttpServletRequest request) {
		...
		if ("ANNUAL".equals(planType)) {
			mv.setViewName("/bpbj/demand_plan/annual_index");
		} else if ("TEMPORARY".equals(planType)) {
			mv.setViewName("/bpbj/demand_plan/temporary_index");
		}
		return mv;
	}
