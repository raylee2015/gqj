...
import com.bpbj.service.IBPBJMaterialBillService;
...
@Controller
@RequestMapping("/bpbj/material_bill")
public class BPBJMaterialBillController extends BaseController {
	public static final Logger LOGGER = Logger
			.getLogger(BPBJMaterialBillController.class);
	...
	@Autowired
	private IBPBJMaterialBillService materialBillService;
	...
	public ModelAndView openChooseBaseToolUI(
		...
		return new ModelAndView(
				"/bpbj/material_bill/chooseBaseToolUI");
	}
	...
	public ModelAndView openChooseDemandPlanUI(
			...
			HttpServletResponse response) {
		return new ModelAndView(
				"/bpbj/material_bill/chooseDemandPlanUI");
	}
	...
	public ModelAndView openChooseDeptUI(
			...
			HttpServletResponse response) {
		return new ModelAndView(
				"/bpbj/material_bill/chooseDeptUI");
	}
	...
	public ModelAndView openChooseMaterialInventoryUI(
			...
			HttpServletResponse response) {
		return new ModelAndView(
				"/bpbj/material_bill/chooseMaterialInventoryUI");
	}
	...
	public ModelAndView openChoosePositionUI(
			...
			HttpServletResponse response) {
		return new ModelAndView(
				"/bpbj/material_bill/choosePositionUI");
	}
	...
	public ModelAndView openChooseStorageUI(
			...
			HttpServletResponse response) {
		return new ModelAndView(
				"/bpbj/material_bill/chooseStorageUI");
	}
	...
	public ModelAndView toIndex() {
		return new ModelAndView("/bpbj/material_bill/index");
	}
