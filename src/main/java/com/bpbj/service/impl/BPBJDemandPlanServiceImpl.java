...
import com.bpbj.dao.BPBJDemandPlanDetailMapper;
import com.bpbj.dao.BPBJDemandPlanMapper;
...
@Service
public class BPBJDemandPlanServiceImpl implements IBPBJDemandPlanService {

	@Autowired
	private BPBJDemandPlanMapper demandPlanMapper;

	@Autowired
	private BPBJDemandPlanDetailMapper demandPlanDetailMapper;
	...
	public Map<String, Object> exportDemandPlans(DemandPlan demandPlan)
		...
		for (String demandPlanId : demandPlanId_arr) {
			...
			String templatePath = this.getClass().getClassLoader()
					.getResource(
							"/com/bpbj/resources/template/demandPlan.xls")
					.getPath();
	...
	public Map<String, Object> exportParentDemandPlans(
		...
		for (String demandPlanId : demandPlanId_arr) {
			...
			String templatePath = this.getClass().getClassLoader()
					.getResource(
							"/com/bpbj/resources/template/parentDemandPlan.xls")
					.getPath();
			String targetPath = BaseSysParam.getSysRootPath()
