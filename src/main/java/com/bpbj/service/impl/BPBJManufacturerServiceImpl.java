...
import com.bpbj.dao.BPBJManufacturerMapper;
...
@Service
public class BPBJManufacturerServiceImpl
		implements IBPBJManufacturerService {

	@Autowired
	private BPBJManufacturerMapper manufacturerMapper;
