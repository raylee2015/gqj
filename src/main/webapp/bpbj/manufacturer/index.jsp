...
<script type="text/javascript">
	...
	function openEditUIForManufacturer(rowIndex) {
		...
		createModalDialog("editUIForManufacturer", url, ("修改厂家\""
				+ rowData.MAN_NAME + "\"的信息"), 400, 120);
		openEditUI('editUIForManufacturer');
	}

	//删除
	function delManufacturers() {
		if (checkSelectedItems('datagridForManufacturer', '请选择厂家')) {
			var ids = getIdsOfSelectedItems('datagridForManufacturer', 'MAN_ID');
			if (ids != null && ids != '') {
				var params = {
					MAN_IDS : ids
				};
				showMessageBox(params, 'delManufacturers.do', '是否删除所选厂家?',
