...
<script type="text/javascript">
	...
	function saveManufacturer() {
		var params = {
			...
			MAN_NAME : getTextBoxValue('manufacturerNameTextBox'),
		};
				...
				<table width="100%">
					<tr>
						...
						<td><input id="manufacturerNameTextBox"
							name="MAN_NAME" class="easyui-textbox"
							data-options="prompt:'厂家名称',required:true,validType:'length[0,20]'"
