...
<script type="text/javascript">
	...
	function saveBaseTool() {
		var params = {
			PLUGIN_ID : getTextBoxValue('baseToolIdTextBox'),
			PLUGIN_NAME : getTextBoxValue('baseToolNameTextBox'),
			TOOL_DEMAND_ID : getTextBoxValue('baseToolDemandIdTextBox'),
			MAN_ID : getTextBoxValue('manufacturerIdTextBox'),
			PLUGIN_MODEL : getTextBoxValue('baseToolModelTextBox'),
			PLUGIN_SPEC : getTextBoxValue('baseToolSpecTextBox'),
			PLUGIN_REMARK : getTextBoxValue('baseToolRemarkTextBox'),
			PLUGIN_EARTH_WIRE : getComboBoxValue('earthWireFlagComboBox')
		};
				...
				<form id="baseToolForm" method="post" style="width: 100%;">
					<div style="display: none">
						<input id="opType" class="easyui-textbox"
							...
							id="baseToolIdTextBox" class="easyui-textbox" name="PLUGIN_ID" />
					...
					<table style="width: 100%; padding: 10px">
						<tr>
							<td width="22%">名称:</td>
							<td><input id="baseToolNameTextBox" name="PLUGIN_NAME"
						...
						<tr>
							<td width="22%">装置型号:</td>
							<td><input id="baseToolModelTextBox" name="PLUGIN_MODEL"
						...
						<tr>
							<td width="22%">具体参数:</td>
							<td><input id="baseToolSpecTextBox" name="PLUGIN_SPEC"
								class="easyui-textbox"
						...
						<tr>
							...
							<td><input id="baseToolRemarkTextBox"
								name="PLUGIN_REMARK" class="easyui-textbox"
								data-options="prompt:'备品备件备注',required:true,validType:'length[0,50]'"
								style="width: 100%; height: 32px" /></td>
						</tr>
					</table>
				</form>
