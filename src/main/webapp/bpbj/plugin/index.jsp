...
<script type="text/javascript">
	...
	function openEditUIForBaseTool(rowIndex) {
		...
		createModalDialog("editUIForBaseTool", url, ("修改插件\""
				+ rowData.PLUGIN_NAME + "\"的基础信息"), 500, 330);
		openEditUI('editUIForBaseTool');
	}

	//删除
	function delBaseTools() {
		if (checkSelectedItems('datagridForBaseTool', '请选择插件基础')) {
			...
			if (ids != null && ids != '') {
				...
				showMessageBox(params, 'delBaseTools.do', '是否删除所选插件基础?',
				...
				<table style="width: 100%">
					<tr>
						...
						<td align="right"><input
							...
							data-options="prompt:'插件基础名称',validType:'length[0,25]'"
