...
var pos=t.passwordbox("getCheckedtart");
...
var _610=$(_60f).timespinner("getCheckedtart");
...
var _ae6=$.grep(grid.datagrid("getChecked"),function(row,_ae7){
...
var vv=[];
$.map(grid.datagrid("getChecked"),function(row){
