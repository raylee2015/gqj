				...
				<table style="width: 100%">
					<tr>
						<td><a href="#" class="easyui-linkbutton"
							...
							onclick="refreshDataGrid('datagridForUser')">刷新</a> <a
							href="#" class="easyui-linkbutton" iconCls="icon-add"
							plain="true" onclick="openAddUIForUser()">添加</a> <a
							href="#" class="easyui-linkbutton"
							iconCls="icon-remove" plain="true"
							onclick="delUsers()">删除</a><a href="#"
							class="easyui-linkbutton" iconCls="icon-reload"
							plain="true" onclick="initUserPassWord()">初始化密码</a></td>
