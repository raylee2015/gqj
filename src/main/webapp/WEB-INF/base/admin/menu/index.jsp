				...
				.datagrid(
						{
							...
							onBeforeLoad : function(param) {
								param.keyWord = getTextBoxValue('keyWordForMenuTextInput');
							},
				...
				<table style="width: 100%">
					<tr>
						<td><a href="#" class="easyui-linkbutton"
							...
							onclick="refreshDataGrid('datagridForMenu')">刷新</a> <a
							href="#" class="easyui-linkbutton" iconCls="icon-add"
							plain="true" onclick="openAddUIForMenu()">添加</a> <a
							href="#" class="easyui-linkbutton"
							iconCls="icon-remove" plain="true"
							onclick="delMenus()">删除</a></td>
						<td align="right"><input
							id="keyWordForMenuTextInput" class="easyui-textbox"
