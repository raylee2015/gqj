				...
				.datagrid(
						{
							...
							onBeforeLoad : function(param) {
								param.keyWord = getTextBoxValue('keyWordForDictionaryTextInput');
							},
				...
				<table style="width: 100%">
					<tr>
						<td><a href="#" class="easyui-linkbutton"
							...
							onclick="refreshDataGrid('datagridForDictionary')">刷新</a>
							<a href="#" class="easyui-linkbutton"
							iconCls="icon-add" plain="true"
							onclick="openAddUIForDictionary()">添加</a> <a href="#"
							class="easyui-linkbutton" iconCls="icon-remove"
							plain="true" onclick="delDictionarys()">删除</a></td>
						<td align="right"><input
							id="keyWordForDictionaryTextInput"
