...
<script type="text/javascript">
	...
	function openEditUIForDept(rowIndex) {
		...
		createModalDialog("editUIForDept", url,
				("修改部门\"" + rowData.DEPT_NAME + "\"的信息"), 400, 240);
		openEditUI('editUIForDept');
	}
