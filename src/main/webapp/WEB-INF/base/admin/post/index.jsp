				...
				.datagrid(
						{
							...
							onBeforeLoad : function(param) {
								param.keyWord = getTextBoxValue('keyWordForPostTextInput');
							},
				...
				<table style="width: 100%">
					<tr>
						<td><a href="#" class="easyui-linkbutton"
							...
							onclick="refreshDataGrid('datagridForPost')">刷新</a> <a
							href="#" class="easyui-linkbutton" iconCls="icon-add"
							plain="true" onclick="openAddUIForPost()">添加</a> <a
							href="#" class="easyui-linkbutton"
							iconCls="icon-remove" plain="true"
							onclick="delPosts()">删除</a></td>
						<td align="right"><input
							id="keyWordForPostTextInput" class="easyui-textbox"
