		...
		<table style="width: 100%">
			...
			<tr>
				...
				<td><a href="#" id="baseToolNameBtn" class="easyui-linkbutton"
					data-options="required:true,prompt:'选择状态'"
					onclick="openChooseBaseToolPanel()"
					style="width: 100%; height: 32px">选择状态</a></td>
			</tr>
			<tr>
				<td width="18%">情况描述:</td>
			...
			<tr>
				<td width="100%" align="right" colspan="2"><a href="#"
					...
					style="width: 60px; height: 32px">保存</a><a href="#" id="closeBtn"
