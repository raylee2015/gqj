...
<script type="text/javascript">
	...
	function saveBaseTool() {
		var params = {
			ACCESSORY_ID : getTextBoxValue('baseToolIdTextBox'),
			ACCESSORY_NAME : getTextBoxValue('baseToolNameTextBox'),
			TOOL_DEMAND_ID : getTextBoxValue('baseToolDemandIdTextBox'),
			MAN_ID : getTextBoxValue('manufacturerIdTextBox'),
			ACCESSORY_MODEL : getTextBoxValue('baseToolModelTextBox'),
			ACCESSORY_SPEC : getTextBoxValue('baseToolSpecTextBox'),
			ACCESSORY_REMARK : getTextBoxValue('baseToolRemarkTextBox'),
			ACCESSORY_EARTH_WIRE : getComboBoxValue('earthWireFlagComboBox')
		};
				...
				<form id="baseToolForm" method="post" style="width: 100%;">
					<div style="display: none">
						<input id="opType" class="easyui-textbox"
							...
							id="baseToolIdTextBox" class="easyui-textbox" name="ACCESSORY_ID" />
					...
					<table style="width: 100%; padding: 10px">
						...
						<tr>
							<td width="22%">装置型号:</td>
							<td><input id="baseToolModelTextBox" name="ACCESSORY_MODEL"
								class="easyui-textbox"
								data-options="prompt:'备品备件型号',required:true,validType:'length[0,20]'"
								style="width: 100%; height: 32px" /></td>
						</tr>
						<tr>
							<td width="22%">具体参数:</td>
							<td><input id="baseToolSpecTextBox" name="ACCESSORY_SPEC"
								class="easyui-textbox"
								data-options="prompt:'备品备件参数',required:true,validType:'length[0,20]'"
								style="width: 100%; height: 32px" /></td>
						</tr>
						<tr>
							<td width="22%">适用站:</td>
						...
						<tr>
							<td width="22%">备品备件备注:</td>
							<td><input id="baseToolRemarkTextBox"
								name="ACCESSORY_REMARK" class="easyui-textbox"
								data-options="prompt:'备品备件备注',required:true,validType:'length[0,20]'"
								style="width: 100%; height: 32px" /></td>
						</tr>
					</table>
				</form>
					...
					<table width="100%">
						<tr>
							<td><input id="keyWordForToolDemandTextInput"
								class="easyui-textbox"
								data-options="prompt:'备品备件名称',validType:'length[0,50]',require : true"
								style="width: 150px"> <a href="#"
								class="easyui-linkbutton" iconCls="icon-search"
								onclick="queryToolDemandPagesForSearch()">查询</a> 备品备件种类: <input
								id="toolTypeComboBox" name="TYPE_ID"
								data-options="valueField : 'ID',textField : 'TEXT',require : true,
							panelHeight : 'auto',	prompt : '备品备件类型',
