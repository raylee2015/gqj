...
<%
	...
	String batchCode = request.getAttribute("BATCH_CODE").toString();
%>
...
<script type="text/javascript">
	...
	function successFunctionForSave(result) {
		...
		var tip1 = "<font color='#0000ff' size=15>" + toolCode + " 已经" + opText
				+ "</font>";
		var tip2 = "<font size=10>已经" + opText + count + "个工器具</font>";
		$("#tip1").html(tip1);
		$("#tip2").html(tip2);
	}
		...
		<table style="width: 100%">
			<tr>
				...
				<td><input id="batchCodeTextInput"
					value="<%=request.getParameter("BATCH_CODE")%>"
