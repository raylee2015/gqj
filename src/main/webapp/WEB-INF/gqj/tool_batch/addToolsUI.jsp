...
<script type="text/javascript">
	...
	function saveBatch() {
		...
		var storageName = getTextBoxValue('storageNameTextInput');
		var positionName = getTextBoxValue('positionNameTextInput');
		var baseToolManName = getTextBoxValue('baseToolManNameTextInput');
