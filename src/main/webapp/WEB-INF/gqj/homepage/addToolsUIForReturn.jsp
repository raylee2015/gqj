...
<script type="text/javascript">
	...
	function saveBatch() {
		...
		var batchReturnUserId = getTextBoxValue('userIdTextInput');
		var params = {
	...
	function successFunctionForSave(result) {
		if (result.success) {
			...
			$("#tip1").empty();
			$("#tip2").empty();
			var tip1 = "<font color='#0000ff' >" + toolCode + " 已经归还</font>";
			var tip2 = "<font >已经归还" + count + "个工器具</font>";
		...
		<table style="width: 100%">
			...
			<tr>
				<td width="100%" align="right" colspan="2"><a href="#"
					...
					style="height: 32px">归还</a><a href="#" id="closeBtn"
