...
<script type="text/javascript">
	...
	function closeChooseToolForPlanUIForTemplate() {
		closeUI('chooseToolForPlanUIForTemplate')
	}

	//打开选择工器具窗口
	function openChooseToolForPlanUIForTemplate() {
		createModalDialog("chooseToolForPlanUIForTemplate",
				"openChooseToolForPlanUI.do?opType=add", "添加工器具", 1000, 600);
		openUI('chooseToolForPlanUIForTemplate');
	}
		...
		<div id="toolbarForTemplateDetail">
			<div>
				<a href="#" class="easyui-linkbutton" plain="true"
					...
					iconCls="icon-ok" plain="true" onclick="saveTemplate()">保存</a><a
					href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true"
					onclick="openChooseToolForPlanUIForTemplate()">添加工器具</a>
			</div>
			<div>
